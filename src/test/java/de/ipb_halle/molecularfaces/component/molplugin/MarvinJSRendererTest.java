...
import static de.ipb_halle.molecularfaces.component.molplugin.MarvinJSComponent.WEBXML_MARVINJS_LICENSE_URL;
 ...
 * @author flange
 */
public class MarvinJSRendererTest {
	private FacesContext context;
	private MockServletContext servletContext;
	private StringWriter writer;
	private MarvinJSComponent comp;
	private MarvinJSRenderer renderer = new MarvinJSRenderer();
	...
	public void init() {
		...
		servletContext.addInitParameter(WEBXML_MARVINJS_LICENSE_URL, "marvin4js-license.cxl");
	...
	public void test_encode_viewer_withoutWidgetVar() throws IOException {
		...
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MarvinJSRendererTest.class,
				"MarvinJSRendererTest_encode_viewer_withoutWidgetVar.txt");
	...
	public void test_encode_viewer_withWidgetVar() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MarvinJSRendererTest.class,
				"MarvinJSRendererTest_encode_viewer_withWidgetVar.txt");
		assertEquals(expected, writer.toString());
	}
	...
	public void test_encode_viewer_withMDLV3000Format() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MarvinJSRendererTest.class,
				"MarvinJSRendererTest_encode_viewer_withMDLV3000Format.txt");
		assertEquals(expected, writer.toString());
	}

	@Test
	public void test_encode_viewer_withWebservices() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MarvinJSRendererTest.class,
				"MarvinJSRendererTest_encode_viewer_withWebservices.txt");
		assertEquals(expected, writer.toString());
	}
	...
	public void test_encode_editor_withoutWidgetVar() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MarvinJSRendererTest.class,
				"MarvinJSRendererTest_encode_editor_withoutWidgetVar.txt");
		assertEquals(expected, writer.toString());
	}
	...
	public void test_encode_editor_withWidgetVar() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MarvinJSRendererTest.class,
				"MarvinJSRendererTest_encode_editor_withWidgetVar.txt");
		assertEquals(expected, writer.toString());
	}
	...
	public void test_encode_editor_withMDLV3000Format() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MarvinJSRendererTest.class,
				"MarvinJSRendererTest_encode_editor_withMDLV3000Format.txt");
		assertEquals(expected, writer.toString());
	}

	@Test
	public void test_encode_editor_withWebservices() throws IOException {
		servletContext.addInitParameter(WEBXML_MARVINJS_WEBSERVICES, "true");
		comp.setId("myId");
		comp.setValue("molfile");
		comp.setWidgetVar("editor1");
