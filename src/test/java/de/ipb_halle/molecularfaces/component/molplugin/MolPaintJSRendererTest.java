...
public class MolPaintJSRendererTest {
	private FacesContext context;
	private MockServletContext servletContext;
	private StringWriter writer;
	private MolPaintJSComponent comp;
	private MolPaintJSRenderer renderer = new MolPaintJSRenderer();
	...
	public void test_encode_viewer_withoutWidgetVar() throws IOException {
		...
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MolPaintJSRendererTest.class,
				"MolPaintJSRendererTest_encode_viewer_withoutWidgetVar.txt");
	...
	public void test_encode_viewer_withWidgetVar() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MolPaintJSRendererTest.class,
				"MolPaintJSRendererTest_encode_viewer_withWidgetVar.txt");
		assertEquals(expected, writer.toString());
	}

	@Test
	public void test_encode_viewer_withCustomResourceUrl_withWidgetVar() throws IOException {
		servletContext.addInitParameter(WEBXML_CUSTOM_RESOURCE_URL, "/plugins/molpaint.js");
		comp = new MolPaintJSComponent();
		comp.setId("myId");
		comp.setValue("molfile");
		comp.setReadonly(true);
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MolPaintJSRendererTest.class,
				"MolPaintJSRendererTest_encode_viewer_withCustomResourceUrl_withWidgetVar.txt");
		assertEquals(expected, writer.toString());
	}
	...
	public void test_encode_editor_withoutWidgetVar() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MolPaintJSRendererTest.class,
				"MolPaintJSRendererTest_encode_editor_withoutWidgetVar.txt");
		assertEquals(expected, writer.toString());
	}
	...
	public void test_encode_editor_withMDLV3000Format() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MolPaintJSRendererTest.class,
				"MolPaintJSRendererTest_encode_editor_withMDLV3000Format.txt");
		assertEquals(expected, writer.toString());
	}
	...
	public void test_encode_editor_withWidgetVar() throws IOException {
		...
		TestUtils.encodeRenderer(renderer, context, comp);
		String expected = TestUtils.readResourceFileIgnoreNewlinesAndTabs(MolPaintJSRendererTest.class,
				"MolPaintJSRendererTest_encode_editor_withWidgetVar.txt");
		assertEquals(expected, writer.toString());
	}
